...
if(isset($_POST['add_mstd'])){        
    ...
    while(($row=fgetcsv($csv,1000,",")) !== FALSE){            
        $pro_id=$row[0];
        $pro_name=$row[1];            
        $sql=$con->query("INSERT INTO product VALUES('$pro_id','$pro_name')");  
                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row" class="info bg-primary">
                                <th tabindex="0" class="text-center">รหัสสินค้า</th>                                
                                <th tabindex="0" class="text-center">ชื่อสินค้า</th>                                                                
                                <th tabindex="0" class="text-center">Manage</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php                                
